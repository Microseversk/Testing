...
class TestSolution(TestCase):
    ...
    def test_palindromic_substrings_count__correct_result(self):
        ...
        """
            Тест проверяет, что функция возвращает правильный счётчик подстрок
        """
    ...
    def test_palindromic_substrings_count__input_string_length_valid(self):
        ...
        """
            Тест проверяет, что функция возвращает правильный счётчик подстрок на граничных валидных длинах входной строки
        """
    ...
    def test_palindromic_substrings_count__input_string_length_invalid(self):
        ...
        """
            Тест проверяет, что функция возвращает AssertionError при невалидной длине входной строки
        """
    ...
    def test_palindromic_substrings_count__input_string_type_invalid(self):
        ...
        """
            Тест проверяет, что функция возвращает TypeError, если входной параметр не имеет тип str
        """
    ...
    def test_palindromic_substrings_count__input_string_value_invalid(self):
        ...
        """
            Тест проверяет, что функция возвращает AssertionError, если входная строка содеожит что-либо кроме английский букв нижнего регистра
        """
        data = [
            '123',
            "123abc123",
